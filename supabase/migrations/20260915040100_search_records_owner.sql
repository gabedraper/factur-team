-- search_records restates the opportunities policy word for word (see the
-- original in 20260911200100). The policy now also lets you see what you or
-- your reports own, so the search must too, or a deal you own is on your
-- pipeline page and missing from the search box.
