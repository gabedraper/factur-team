...
import { OpportunityViewTools } from "@/components/pipeline/OpportunityViewEditor";
  ...
  return (
    <div className="space-y-4 p-section">
      ...
      <PageHeader
        ...
        count={error || tooBroad ? undefined : `${rows.length}${hasMore ? "+" : ""}`}
      />

      <div className="flex flex-wrap items-center gap-1.5">
        {/* useSearchParams inside needs a boundary. */}
        <Suspense fallback={<div className="h-7" />}>
          <ViewSwitcher entity="opportunities" pinned={views.pinned} rest={views.rest} />
        </Suspense>
