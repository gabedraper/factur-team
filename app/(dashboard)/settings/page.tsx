  ...
  return (
    <div className="p-6 space-y-6 max-w-3xl">
      ...
      <Surface as="section" className="space-y-3">
        <h2 className="text-body font-medium">You</h2>
        <dl className="grid grid-cols-[8rem_1fr] gap-y-2 text-body">
      ...
      <Surface as="section" className="space-y-3">
        <h2 className="text-body font-medium">Appearance</h2>
        <ThemePanel />
      </Surface>

      {canPreview && (
        <Surface as="section" className="space-y-3">
          <h2 className="text-body font-medium">Preview</h2>
          <PreviewPanel
            people={people}
        ...
        <section className="space-y-3">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <Link href="/settings/people"
              ...
              <span>
                <span className="block text-body font-medium">People</span>
            ...
            <Link href="/settings/roles"
              ...
              <span>
                <span className="block text-body font-medium">Roles &amp; permissions</span>
                <span className="block text-meta text-muted-foreground">
            ...
            {canAdminTalent && (
              <Link href="/settings/talent"
                ...
                <span>
                  <span className="block text-body font-medium">Talent</span>
                  <span className="block text-meta text-muted-foreground">
            ...
            <Link href="/settings/design"
              ...
              <span>
                <span className="block text-body font-medium">Design reference</span>
                <span className="block text-meta text-muted-foreground">
            ...
            <Link href="/settings/performance"
              ...
              <span>
                <span className="block text-body font-medium">Performance</span>
                <span className="block text-meta text-muted-foreground">
            ...
            <Link href="/settings/agents"
              ...
              <span>
                <span className="block text-body font-medium">Agents</span>
                <span className="block text-meta text-muted-foreground">
            ...
            <Link href="/settings/nps"
              ...
              <Gauge className="mt-0.5 h-4 w-4 shrink-0 text-muted-foreground" />
              <span>
                <span className="block text-body font-medium">NPS</span>
                <span className="block text-meta text-muted-foreground">
            ...
            {canEditSequences && (
              <Link href="/settings/sequences"
                ...
                <span>
                  <span className="block text-body font-medium">Sequences</span>
                  <span className="block text-meta text-muted-foreground">
            ...
            {canEditWeights && (
              <Link href="/admin/weights"
                ...
                <span>
                  <span className="block text-body font-medium">Scoring Weights</span>
                  <span className="block text-meta text-muted-foreground">
            ...
            <Link href="/settings/clients"
              ...
              <span>
                <span className="block text-body font-medium">Clients</span>
                <span className="block text-meta text-muted-foreground">
            ...
            <Link href="/settings/teams"
              ...
              <span>
                <span className="block text-body font-medium">Pods</span>
                <span className="block text-meta text-muted-foreground">
            ...
            <Link href="/settings/services"
              ...
              <span>
                <span className="block text-body font-medium">Services</span>
                <span className="block text-meta text-muted-foreground">
