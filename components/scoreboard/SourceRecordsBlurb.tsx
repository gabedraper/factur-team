...
export function SourceRecordsBlurb({
  ...
  return (
    <div className="pointer-events-none absolute right-full top-1/2 z-10 -translate-y-1/2 pr-3 group-hover:pointer-events-auto">
      <div className="relative max-h-96 w-[28rem] overflow-y-auto rounded-md border border-border bg-popover p-3 text-xs opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
